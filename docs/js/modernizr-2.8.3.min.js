window.Modernizr = (function(e, t, n) {
  ...
  function l() {
    (p.input = (function(n) {
      ...
      return j.list &&
        (j.list = !(!t.createElement('datalist') || !e.HTMLDataListElement)), j;
    })(
      ...
      for (var r, o, a, i = 0, c = e.length; c > i; i++)
        E.setAttribute('type', (o = e[i])), (r = 'text' !== E.type), r &&
          (
            (E.value = x),
  ...
  var d,
    ...
    F = function(e, n, r, o) {
      ...
      if (parseInt(r, 10))
        for (; r--; )
          (c = t.createElement('div')), (c.id = o
            ? o[r]
            : v + (r + 1)), u.appendChild(c);
      return (a = ['&#173;', '<style id="s', v, '">', e, '</style>'].join(
        ''
      )), (u.id = v), ((l ? u : d).innerHTML += a), d.appendChild(u), l ||
        (
          (d.style.background = ''),
  ...
  (f =
    ...
    return r('background-color:rgba(150,255,150,.5)'), i(
      b.backgroundColor,
      'rgba'
    );
  }), (M.hsla = function() {
    return r('background-color:hsla(120,40%,100%,.5)'), i(
      b.backgroundColor,
      'rgba'
    ) || i(b.backgroundColor, 'hsla');
    ...
    var e;
    return F('@font-face {font-family:"font";src:url("https://")}', function(
      n,
      r
    ) {
    ...
    return (e.innerHTML = '<svg/>'), (e.firstChild &&
      e.firstChild.namespaceURI) == N.svg;
  }), (M.smil = function() {
    return (
      !!t.createElementNS &&
  ...
  return p.input || l(), (p.addTest = function(e, t) {
    ...
    !(function() {
      try {
        ...
        (e.innerHTML = '<xyz></xyz>'), (u = 'hidden' in e), (l =
    ...
    this,
    t
  ), (p._version = m), (p._prefixes = S), (p._domPrefixes = T), (p._cssomPrefixes = k), (p.mq = z), (p.hasEvent = A), (p.testProp = function(
    e
  ) {
    return c([e]);
  }), (p.testAllProps = u), (p.testStyles = F), (p.prefixed = function(
    e,
    t,
    n
  ) {
