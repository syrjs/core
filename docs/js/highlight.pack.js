!(function(e) {
  ...
  function a(e) {
    var n = (e.className +
      ' ' +
      (e.parentNode ? e.parentNode.className : '')).split(/\s+/);
    ...
    function r(a, o) {
      if (!a.compiled) {
        ...
        (a.lR = t(a.l || /\b\w+\b/, !0)), o &&
          ...
          ), a.i && (a.iR = t(a.i)), void 0 === a.r && (a.r = 1), a.c ||
          (a.c = []);
        var s = [];
  ...
  function s(e, t, a, i) {
    ...
    function d() {
      ...
      for (var r = L.lR.exec(y); r; ) {
        ...
        var a = g(L, r);
        a ? ((B += a[1]), (e += p(a[0], n(r[0])))) : (e += n(r[0])), (t =
          L.lR.lastIndex), (r = L.lR.exec(y));
      }
    ...
    function h() {
      ...
      return L.r > 0 &&
        (B +=
          e.r), 'continuous' == L.subLanguageMode && (M[L.sL] = e.top), p(e.language, e.value, !1, !0);
    }
    function b() {
  ...
  function p(e) {
    ...
    if (!/no(-?)highlight|plain|text/.test(n)) {
      ...
      (i.value = f(i.value)), (e.innerHTML = i.value), (e.className = g(
        e.className,
        n,
        i.language
      )), (e.result = { language: i.language, re: i.r }), i.second_best &&
        (e.second_best = {
...
hljs.registerLanguage('lisp', function(b) {
  var e =
    ...
    q = { eW: !0, r: 0 };
  return (g.c = [
    { cN: 'keyword', v: [{ b: e }, { b: c }] },
    q,
  ]), (q.c = [v, f, g, i, l, t, d, n, u, o, N]), { i: /\S/, c: [l, a, i, t, d, v, f, g, N] };
});
...
hljs.registerLanguage('clojure', function(e) {
  ...
  return (f.c = [
    ...
    y,
    h,
  ]), (h.c = b), (l.c = b), { aliases: ['clj'], i: /\S/, c: [f, i, m, p, c, u, l, s, d] };
});
...
hljs.registerLanguage('twig', function(e) {
  ...
  return (n =
    ...
    n
      ...
      .join(
        ' '
      )), { aliases: ['craftcms'], cI: !0, sL: 'xml', subLanguageMode: 'continuous', c: [e.C(/\{#/, /#}/), { cN: 'template_tag', b: /\{%/, e: /%}/, k: n, c: [c, r] }, { cN: 'variable', b: /\{\{/, e: /}}/, c: [c, r] }] };
});
