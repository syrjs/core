(function(global, factory) {
        ...
        if (name.indexOf('.') > 0) {
          ...
          while (value != null && index < names.length) {
            if (index === names.length - 1 && value != null)
              lookupHit =
                typeof value === 'object' && value.hasOwnProperty(names[index]);
  ...
  Writer.prototype._renderSection = function(
    token,
    context,
    partials,
    originalTemplate
  ...
  Writer.prototype._renderInverted = function(
    token,
    context,
    partials,
    originalTemplate
