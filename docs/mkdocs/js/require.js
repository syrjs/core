...
(function(ba) {
              ...
              if (!this.defining) {
                ...
                if (1 > this.depCount && !this.defined) {
                  if (G(l)) {
                    ...
                    if (a)
                      return (a.requireMap = this.map), (a.requireModules = this
                        .map.isDefine
                        ? [this.map.id]
                        : null), (a.requireType = this.map.isDefine
                        ? 'define'
                        : 'require'), w((this.error = a));
                  } else f = l;
                  this.exports = f;
                  if (
                    this.map.isDefine &&
  ...
  if ('undefined' === typeof define) {
    ...
    g.load = function(b, c, d) {
      var e = (b && b.config) || {};
      if (z)
        return (e = g.createNode(e, c, d)), e.setAttribute(
          'data-requirecontext',
          b.contextName
        ), e.setAttribute('data-requiremodule', c), e.attachEvent &&
        !(
    ...
    z &&
      ...
      T(document.getElementsByTagName('script'), function(b) {
        ...
        if ((I = b.getAttribute('data-main')))
          return (s = I), q.baseUrl ||
            (
              (E = s.split('/')),
              (s = E.pop()),
              (O = E.length ? E.join('/') + '/' : './'),
              (q.baseUrl = O)
            ), (s = s.replace(Q, '')), g.jsExtRegExp.test(s) &&
            (s = I), (q.deps = q.deps ? q.deps.concat(s) : [s]), !0;
      });
    define = function(b, c, d) {
      ...
      !c &&
        ...
        (
          ...
          d.length &&
            (
              d.toString().replace(ka, '').replace(la, function(b, d) {
                c.push(d);
              }),
              (c = (1 === d.length
                ? ['require']
                : ['require', 'exports', 'module']).concat(c))
            )
        );
      if (M) {
        if (!(e = J))
