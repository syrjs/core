...
!(function() {
  var t = function(e) {
    var n = new t.Index();
    return n.pipeline.add(t.trimmer, t.stopWordFilter, t.stemmer), e &&
      e.call(n, n), n;
  };
  (t.version = '0.7.0'), (t.utils = {}), (t.utils.warn = (function(t) {
    ...
    if (this.hasHandler(t)) {
      ...
      this.events[t].splice(n, 1), this.events[t].length ||
    ...
    n in this.registeredFunctions &&
      t.utils.warn(
        'Overwriting existing tokenizer: ' + n
      ), (e.label = n), (this.registeredFunctions[n] = e);
  }), (t.Pipeline = function() {
    this._stack = [];
  }), (t.Pipeline.registeredFunctions = {}), (t.Pipeline.registerFunction = function(
    e,
    n
  ) {
    n in this.registeredFunctions &&
    ...
    for (
      ...
      if (o === t) return r;
      t > o && (e = r), o > t && (n = r), (i = n - e), (r =
        e + Math.floor(i / 2)), (o = this.elements[r]);
    }
    return o === t ? r : -1;
    ...
    this.length >= t.length
      ? ((e = this), (n = t))
      : ((e = t), (n = this)), (i = e.clone());
    for (var r = 0, o = n.toArray(); r < o.length; r++) i.add(o[r]);
    return i;
  }), (t.SortedSet.prototype.toJSON = function() {
    return this.toArray();
  }), (t.Index = function() {
    (this._fields = []), (this._ref =
      'id'), (this.pipeline = new t.Pipeline()), (this.documentStore = new t.Store()), (this.tokenStore = new t.TokenStore()), (this.corpusTokens = new t.SortedSet()), (this.eventEmitter = new t.EventEmitter()), (this.tokenizerFn =
      t.tokenizer), (this._idfCache = {}), this.on(
      'add',
      'remove',
      'update',
      function() {
    ...
    var n = new this();
    return (n._fields = e.fields), (n._ref =
      e.ref), (n.tokenizer = t.tokenizer.load(
      e.tokenizer
    )), (n.documentStore = t.Store.load(
      e.documentStore
    )), (n.tokenStore = t.TokenStore.load(
      e.tokenStore
    )), (n.corpusTokens = t.SortedSet.load(
      e.corpusTokens
    )), (n.pipeline = t.Pipeline.load(e.pipeline)), n;
    ...
    var e = void 0 === e ? !0 : e;
    this.remove(t, !1), this.add(t, !1), e &&
      this.eventEmitter.emit('update', t, this);
    ...
    var n = this.tokenStore.count(t),
      i = 1;
    return n > 0 &&
      (i = 1 + Math.log(this.documentStore.length / n)), (this._idfCache[
      e
    ] = i);
    ...
    var n = new this();
    return (n.length = e.length), (n.store = Object.keys(
      e.store
    ).reduce(function(n, i) {
    ...
    var t = {
      ...
      T = function(n) {
        ...
        if (((s = z), s.test(n))) {
          var T = s.exec(n);
          (i = T[1]), (s = c), (a = f), (h = P), (s.test(i) ||
            (a.test(i) && !h.test(i))) &&
            (n = i);
        }
        return (s = O), (a = c), s.test(n) &&
          a.test(n) &&
          ((s = y), (n = n.replace(s, ''))), 'y' == o &&
          (n = o.toLowerCase() + n.substr(1)), n;
      };
    return T;
    ...
    var n = n || this.root,
      i = t.charAt(0),
      r = t.slice(1);
    return i in n || (n[i] = { docs: {} }), 0 === r.length
    ...
    var n = this.getNode(t),
      i = n.docs || {},
      e = e || [];
    return Object.keys(i).length && e.push(t), Object.keys(n).forEach(function(
      n
    ) {
