...
class animated extends Component {
  ...
  start(callback) {
    ...
    console.log('target', this.AnimationTargets[animation.guid]);
    RasterManager.getRaster().sendMessage('animation', {guid:this.AnimationTargets[animation.guid], animation:animation});
  }
}
