  ...
  function reflow(component, passedUpdates) {
    ...
    if(component.children) {
      ...
      if(component.children.length !== updates.length) {
        updatedChildren = updates.filter((child) => {
          if(component.children.filter((oldChild) => {
            let newUuid = component.instance.guid + '-' + child.guid;
            ...
            child.uuid = component.instance.guid + '-' + child.guid;
            return oldChild.instance.uuid === (newUuid)
          }).length > 0) {
            return false;
          }
          return true;
        ...
        updatedChildren.forEach((child) => {
          component.children.push(createComponent(child));
        });
        console.log('New children 123', component.children);
