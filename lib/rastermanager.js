...
const prepareProps = component => {
  ...
  // @TODO: we will have to have a dictionary of all available events and cycle thru it to detach from props
  ...
  if (component.attributes.onValueChange) {
    component.instance.onValueChange = component.attributes.onValueChange;
    delete component.attributes.onValueChange;
  }
