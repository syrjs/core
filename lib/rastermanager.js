...
const createComponent = (ast, fenceid) => {
  ...
  if (ast.children) {
    ...
    console.log('Right After >>', ast.children);
    ast.children.forEach(function (child, index) {
        if (typeof child !== 'string' && typeof child !== 'number') {
          ...
          console.log('OLD UUId', JSON.stringify(child.uuid), JSON.stringify( fenceid + '-' + child.guid))

          console.log('New UUId', child.uuid)
        }
