    ...
    if(component.children) {
      ...
      if(component.children.length !== updates.length) {
       ...
       updates.forEach((child) => {
           let newChild = returnChild(child, component) || createComponent(child);
...
function returnChild(child, component) {
  component.children.forEach((oldChild) => {
   ...
   child.uuid = oldChild.fenceid + '-' + child.guid;
   child.fenceid = oldChild.fenceid;
