...
RasterManager.render = component => {
  ...
  if (typeof component == 'function') {
    ...
    // update path
    let inflated = createComponent(component.render());
    let cached = _instances[component.guid].children[0];
    inflated.instance.guid = cached.instance.guid
    remap(inflated, cached);
    inflated.update = true;
    _instances[component.guid].children[0] = inflated;
    console.log(_instances[component.guid]);
    _raster.render(inflated);
  }
};
