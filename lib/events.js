...
class events {
  constructor() {
    ...
    this.register = component => {
      if(uuids[component.uuid] == '' && (this.components[component.uuid] !== component)) {
        console.warn('event registered twice >>> ', this.components[component.uuid], component);
        return;
      }
    ...
    function handleLifeCycle(event, component) {
      ...
      let walk = (event, component) => {
        ...
        if (handler) {
          ...
          if (!lifeCycleNotifiers[lifeCycleID] || lifeCycleNotifiers[lifeCycleID].component !== component) {
