...
+(NSObject*) render: (NSDictionary*) component withInstance: (NSObject*) componentInstance  {
  ...
  if(componentInstance != nil) {
    ...
    // [button addTarget:[[SyrEventHandler sharedInstance] assignDelegate:guid]
    //            action:selector
    //  forControlEvents:UIControlEventTouchUpInside];

    // @TODO: going the touchable opacity route for now.
    // Will need to come back and look at how to do this
    // on a UIButton without subClassing it.
