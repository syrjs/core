...
class OtherClass extends Component {
  ...
  render() {
    return (
      ...
      >
        <View style={{ height: 800, width: 500, backgroundColor: this.state.color }} />
      </TouchableOpacity>
    );
  }
}
...
class AnOtherClass extends Component {
  ...
  render() {
    return (
      ...
      >
        <View style={{ height: 500, width: 500, backgroundColor: this.state.color }} />
      </TouchableOpacity>
    );
  }
}
...
class SomeOtherClass extends Component {
  ...
  render() {
    return (
      ...
      >
        <View style={{ height: 600, width: 500, backgroundColor: this.state.color }} />
      </TouchableOpacity>
    );
  }
}
