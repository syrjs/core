...
class OtherClass extends Component {
  render() {
    return (
      <View  style={{top:200,height:100, width:300, backgroundColor:'#0000ff'}}>
    ...
    return (
      <View style={{height:300, width:300, backgroundColor:'#000000'}}>
        <View  style={{height:100, width:300, backgroundColor:'#ff00ff'}}>
          <Text style={{height:100, width:300}}>{ this.props.data.testMessage }</Text>
        </View>
        <View  style={{top:100,height:100, width:300, backgroundColor:'#00ff00'}}>
          <Text style={{height:100, width:300}}>{'woooot'}</Text>
        </View>
        <OtherClass/>
      </View>
